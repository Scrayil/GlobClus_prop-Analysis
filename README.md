...
This aim of this project is to analyze globular stars clusters in the Milky Way, in order to understand their dynamics.  
...
**Note:** The distribution for this study has been assumed as linear (known beforehand).
